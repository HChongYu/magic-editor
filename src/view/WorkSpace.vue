    ...
    <div class="container">
      ...
      <div class="main">
          <ProductHeader 
            ...
            @name-change="handleProductNameChange"
      ...
      <RightSidebar 
        :show-toolbar="showEditorToolbar"
        :extensions-count="customExtensions.length"
        :has-editor-instance="!!editorInstance"
        @get-content="getEditorContent"
        @set-content="setEditorContent"
